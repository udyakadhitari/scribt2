  ...
  return (
    <div className="bg-background text-on-background font-body-md h-screen flex overflow-hidden antialiased animate-pulse">
      ...
      <div className="flex-1 flex flex-col md:pl-[280px] h-screen">
        ...
        {/* Toolbar Skeleton */}
        <div className="h-10 border-b border-outline-variant bg-surface shrink-0 flex items-center px-lg gap-md">
          <div className="w-24 h-6 bg-surface-container rounded" />
          <div className="w-px h-5 bg-outline-variant" />
          <div className="w-32 h-6 bg-surface-container rounded" />
          <div className="w-px h-5 bg-outline-variant" />
        ...
        {/* Canvas Area Loader */}
        <main className="flex-1 flex flex-col items-center justify-center bg-surface-container-high p-lg select-none">
          <BookLoad />
          <p className="text-secondary font-headline-sm mt-md animate-pulse">Loading note...</p>
        </main>
      </div>
    </div>
  );
