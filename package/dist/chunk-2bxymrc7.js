...
class ViewCommandHandler {
  ...
  async executeServeMode(options) {
    ...
    const { ViewHandler } = await import("./chunk-mz76qtcf.js");
    ...
    const { StitchViteServer } = await import("./chunk-rgz0wgf5.js");
  ...
  async executeInteractiveMode(options) {
    ...
    const { InteractiveViewer } = await import("./chunk-tsfray7d.js");
    const { ViewHandler } = await import("./chunk-mz76qtcf.js");
    const handler = new ViewHandler;
