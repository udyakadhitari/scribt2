...
async function loadCommands() {
  const commands = [];
  try {
    let commandsDir = __dirname2;
    try {
      const rootEntries = await readdir(__dirname2, { withFileTypes: true });
      if (rootEntries.some((e) => e.isDirectory() && e.name === "commands")) {
        commandsDir = join(__dirname2, "commands");
      }
    } catch (e) {}
...
program2.name("stitch-mcp").description("Stitch MCP OAuth setup assistant").version(pkg.version);
...
//# debugId=ACE2ACCA779D8D0064756E2164756E21
